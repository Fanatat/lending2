...
export default function AllInSection() {
  return (
    <SectionShell
      id="all-in"
      number="СИСТЕМА 05"
      title="Аналитика крипто-портфеля, которая видит, где рынок наказывает жадных"
      line="Система видит ситуацию на рынке и ваши активы, сравнивает инструменты и показывает математику рисков. Но по устройству не способна нажать кнопку «Купить»."
