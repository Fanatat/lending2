 ...
 *
 *   0.0 s  painted marbles spin in a ring right around the camera
...
export const INTRO_T = {
  /** Camera starts pulling away from the marble ring. */
  ringPullback: 2500,
...
/** Marble ring + sparkle dust density (desktop / mobile). */
export const INTRO_MARBLES = { desktop: 15, mobile: 12 };
